...
for year in {1981..2010}
    ...
    cdo -chname,FSDS,global_horizontal -sellonlatbox,-15,50,30,75 -selname,FSDS /net/meso/climphys/cesm212/b.e212.BHISTcmip6.f09_g17.0900/archive/atm/hist/b.e212.BHISTcmip6.f09_g17.0900.cam.h2.${year}-01-01-00000.nc ../../output/global_horizontal_${year}_mod.nc
