...
for i in {1981..2010}
    ...
    cdo -sellonlatbox,-15,50,30,75 -selhour,0,6,12,18 -remapcon,/net/meso/climphys/flehner/observations/era5/day/CESM_atm_grid.txt -selname,s_hub -expr,"s_hub=sqrt(U*U+V*V);" ../output/tmp_"${i}"_s_hub_uv.nc ../output/tmp_"${i}"_s_hub.nc
