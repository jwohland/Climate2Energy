...
for mem in 0900 1000 1100 1200 1300 1400 1500
    do

    for year in {1981..2010}
        do
        # temperature
        cdo -chname,TREFHT,temperature -selname,TREFHT -sellonlatbox,-15,50,30,75 /net/meso/climphys/cesm212/b.e212.BHISTcmip6.f09_g17.${mem}/archive/atm/hist/b.e212.BHISTcmip6.f09_g17.${mem}.cam.h1.${year}-01-01-00000.nc /net/xenon/climphys/lbloin/energy_boost/temperature_${mem}_${year}.nc

        # solar flux
        cdo -selname,FSDS /net/meso/climphys/cesm212/b.e212.BHISTcmip6.f09_g17.${mem}/archive/atm/hist/b.e212.BHISTcmip6.f09_g17.${mem}.cam.h2.${year}-01-01-00000.nc /net/xenon/climphys/lbloin/energy_boost/FSDS_${mem}_${year}.nc
        
        # wind
        cdo -selname,s_hub -expr,"s_hub=sqrt(U*U+V*V);" -sellevidx,31 /net/meso/climphys/cesm212/b.e212.BHISTcmip6.f09_g17.${mem}/archive/atm/hist/b.e212.BHISTcmip6.f09_g17.${mem}.cam.h3.${year}-01-01-00000.nc /net/xenon/climphys/lbloin/energy_boost/s_hub_${mem}_${year}.nc    
...
for var in temperature FSDS s_hub
    do
    #by member
    cdo -sellonlatbox,-15,50,30,75 -merge /net/xenon/climphys/lbloin/energy_boost/${var}_*.nc ../output/hist_${var}.nc
